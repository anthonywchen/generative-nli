...
TUNABLE_PARAMETERS = ['batch_size', 'disc_loss_weight', 'lr', 'num_epochs', 'dropout', 'grad_clipping', 'weight_decay', 'warmup_proportion']
...
def main():
	...
	for c, params in config_iterator:
		# Name this config's serialization directory
